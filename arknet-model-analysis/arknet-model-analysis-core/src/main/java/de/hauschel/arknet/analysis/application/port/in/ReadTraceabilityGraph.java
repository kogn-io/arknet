 ...
 * trace_matrix}, {@code orphan_check}, {@code impact_analysis}, {@code role_usecase_matrix} and
 * {@code term_cooccurrence}.
 *
 * <p>All five tools answer different questions about the same graph, so they share one in-port
