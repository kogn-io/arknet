...
/**
 * Driving port: correct a project's optional description and/or default display language after
 * the fact.
 *
...
public interface UpdateProject {
     ...
     */
    Project update(ProjectId projectId, String description, String descriptionLanguage, String defaultLanguage);
}
