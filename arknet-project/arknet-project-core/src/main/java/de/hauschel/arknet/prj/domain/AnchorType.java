...
/**
 * The kind of {@link Anchor} value a client sends.
 *
 ...
 * inspection the anchor model removes. Deliberately open to growth ("later further types")
 * without being unbounded: an enum, not a free-form string, so a caller can never
