...
public final class AdrMcpTools {
    ...
    @McpTool(name = "adr_delete", description = "Delete a recorded architecture decision and every "
            ...
            + "architecture decision. Once a decision has a real place in the model's history - "
            + "superseded, deprecated, or deliberately turned down - the record stays: an ACCEPTED "
            + "decision is superseded with adr_supersede or marked obsolete with adr_set_status "
            + "DEPRECATED, while a REJECTED, DEPRECATED or SUPERSEDED one simply stays as it is - "
            + "neither of those two paths is open there, and the refusal names the one that fits "
            + "the status. REJECTED in particular is not a way to get rid of a "
