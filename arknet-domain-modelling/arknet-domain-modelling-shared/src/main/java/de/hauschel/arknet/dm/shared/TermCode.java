...
package de.hauschel.arknet.dm.shared;

import java.util.Objects;

/**
 * Human-readable business label of a {@code Term}, e.g. {@code TERM-1}.
 *
 ...
 * from {@code TermId}: the code is what a human types (into {@code term_get}) and what
