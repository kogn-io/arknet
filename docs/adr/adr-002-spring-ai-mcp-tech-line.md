...
In-Adapter Spring AI 2.0 (`@McpTool`) hinzu.
...
- Der spring-basierte Client-Security-Weg fuer
...
- Forgejo kogn-io/arknet #26 (requirements-Komponente MVP), #27 (arknet-mcp-Migration,
  erledigt).
- Ein internes Vorlaeuferprojekt (Vorbild fuer den Bean-Stil; dort webmvc-Transport statt
  stdio).
