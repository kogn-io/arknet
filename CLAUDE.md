...
- **arknet-product-requirements**: Kontext-Parent (packaging pom, kein Code) des Bounded Context Produkt & Anforderungen (BC-1); darunter das Vokabularmodul **arknet-product-requirements-shared** (`RequirementCode`, `ConstraintCode`, `TermRef`, Package `de.hauschel.arknet.pr.shared`) und die zwei Komponenten arknet-requirements und arknet-use-cases. `arknet-product-requirements/CLAUDE.md`
...
- **arknet-domain-modelling**: Kontext-Parent (packaging pom, kein Code) des Bounded Context Domain Modelling (BC-2); darunter das Vokabularmodul **arknet-domain-modelling-shared** (`TermCode`, Package `de.hauschel.arknet.dm.shared`) und die zwei Komponenten arknet-ubiquitous-language und arknet-bounded-context. `arknet-domain-modelling/CLAUDE.md`
