...
- **arknet-bounded-context**: vierte hexagonale BC -- BoundedContext-Lifecycle (`bc_*`-Tools), ubiquitousLanguageTerm-Kante ins Glossar (BC->Term), opake Identitaet. Details: `arknet-bounded-context/CLAUDE.md`
