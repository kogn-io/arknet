...
- **arknet-adr**: einzige Komponente des Bounded Context Architektur & Entscheidungen (BC-3) -- Architecture-Decision-Record-Lifecycle (`adr_*`, `adr_check`), Kanten zu Requirements, Bounded Contexts und Glossar, `supersededBy`/`relatedTo` selbstbezueglich; arknets eigene ADRs sind Records dieses Hexagons. `arknet-adr/CLAUDE.md`
