...
- **arknet-project**: einzige Komponente des Bounded Context Projekt-Registry (BC-5, ein Kontext mit einer Komponente bekommt weder eigenen Parent noch Vokabularmodul) -- die Projekt-Registry (`project_*`), bildet den Anker eines Aufrufs auf das Projekt ab; einziger nicht projekt-scoped BC (System-Dataset); fuehrt Standardsprache und Sprachsatz des Projekts. `arknet-project-registry/arknet-project/CLAUDE.md`
