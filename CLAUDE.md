...
- **arknet-product-requirements**: Kontext-Parent (packaging pom, kein Code) des Bounded Context Produkt & Anforderungen; darunter das Vokabularmodul **arknet-product-requirements-shared** (`RequirementCode`, `ConstraintCode`, `TermRef`, Package `de.hauschel.arknet.pr.shared`) und die zwei Komponenten arknet-requirements und arknet-use-cases. `arknet-product-requirements/CLAUDE.md`
