...
- **arknet-ubiquitous-language**: BC 2 -- SKOS-Glossar (`term_*`). `arknet-domain-modelling/arknet-ubiquitous-language/CLAUDE.md`
...
- **arknet-bounded-context**: BC 4 -- BoundedContext-Lifecycle (`bc_*`), ContextRelationship als eigene Ressource. `arknet-domain-modelling/arknet-bounded-context/CLAUDE.md`
