...
- **arknet-mcp**: MCP-Server (geteilter lokaler Daemon, `127.0.0.1:47331`) + Composition Root, verdrahtet alle sieben Komponenten-Hexagons, die Anker-Aufloesung, den generischen Store-Lesepfad, den Pruefpfad `store_check` und das Suchwerkzeug `text_search`. `arknet-mcp/CLAUDE.md`
