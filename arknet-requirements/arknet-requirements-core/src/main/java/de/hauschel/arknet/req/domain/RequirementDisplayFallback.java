...
/**
 * Whether {@code req_list} had to fall back past the requested/project-default display language
 * for a requirement's {@code title}/{@code description}, and if so, the language tag of the
 * variant actually shown (kogn-io/arknet#475). Mirrors {@code TermDisplayFallback}
 * (arknet-ubiquitous-language) exactly, one BC over.
 *
 ...
 */
public record RequirementDisplayFallback(String titleTag, String descriptionTag) {
