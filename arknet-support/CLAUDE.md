...
Er haelt `arknet-persistence-support` (Support der kognio-rdf-Adapter), `arknet-persistence-test-support` (dessen Testseite) und `arknet-mcp-support` (Support der treibenden MCP-Adapter und des Composition Root).
Kein eigenes `dependencyManagement`: die Root-POM fuehrt die Versionen aller drei Module bereits ueber ihre artifactIds.

Detail je Modul: `arknet-persistence-support/CLAUDE.md`, `arknet-persistence-test-support/CLAUDE.md`, `arknet-mcp-support/CLAUDE.md`.
