...
public interface UseCaseRepository {
     ...
     *                                          failure modes
     */
    void create(WorkspaceId workspaceId, UseCase useCase);
     ...
     */
    void update(WorkspaceId workspaceId, UseCase useCase);
     ...
     */
    Optional<UseCase> findByCode(WorkspaceId workspaceId, UseCaseCode code);
