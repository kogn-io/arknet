 ...
 *
 * <p>Extracted out of {@code StoreReportTools} so {@code impact_analysis} - one of the five
 * traceability tools in package {@code de.hauschel.arknet.analysis.adapter.mcp} ({@code trace_matrix},
