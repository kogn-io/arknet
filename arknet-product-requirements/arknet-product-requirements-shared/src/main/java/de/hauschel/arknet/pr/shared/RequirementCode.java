...
/**
 * Human-readable business label of a {@code Requirement}, e.g. {@code FR-1} or {@code NFR-7}.
 *
 ...
 * from {@code RequirementId}: the code is what a human types (into {@code req_get},
