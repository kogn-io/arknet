...
/**
 * Human-readable business label of a {@code Constraint}, e.g. {@code TCON-1}, {@code BCON-3} or
 * {@code RCON-1}.
 *
 ...
 * type. Deliberately separate from {@code ConstraintId}: the code is what a human types (into
